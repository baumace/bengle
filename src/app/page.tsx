...
function App() {
  ...
  useEffect(() => {
    setPicksArray(
      draftPicks.filter((player) => filterPlayersByEra(player, selectedEra)),
    );
  }, [selectedEra]);
  ...
  function setNewPlayer() {
    setCorrectPlayer(picksArray[Math.floor(Math.random() * picksArray.length)]);
  }
  ...
  function HelpPopUp() {
    return (
      <PopUp isVisible={isHelpPopupActive} setIsVisible={setHelpPopupActive}>
        <div className="font-lg">
          <ul>
            ...
            <li className="p-2">
              A{" "}
              <mark className="bg-green-300 dark:bg-green-700">green box</mark>{" "}
            ...
            <li className="p-2">
              ...
              for the year means the correct player is within 5 years
            </li>
            <li className="p-2">
              A{" "}
              <mark className="bg-yellow-200 dark:bg-yellow-600">
              ...
              for the position means the correct player is on the same unit
            </li>
            <li className="p-2">
              A{" "}
              <mark className="bg-yellow-200 dark:bg-yellow-600">
              ...
              for the round means the correct player is within 2 rounds
            </li>
            <li className="p-2">
              A{" "}
              <mark className="bg-yellow-200 dark:bg-yellow-600">
              ...
              on the picks means the correct player is within 20 picks
            </li>
          </ul>
        </div>
      </PopUp>
      ...
      >
        <div className="grid grid-cols-1 gap-2 place-items-center justify-items-center">
          ...
          <Dropdown text={selectedEra}>
            ...
            <DropdownItem fn={() => setSelectedEra(Era.TWO_THOUSAND_TENS)}>
              {Era.TWO_THOUSAND_TENS}
            </DropdownItem>
            <DropdownItem fn={() => setSelectedEra(Era.TWO_THOUSAND)}>
              {Era.TWO_THOUSAND}
            </DropdownItem>
      ...
      >
        <div className="font-lg">
          {correctPlayerGuessed ? (
            <div>
              <p>Draft grade: A+</p>
              <p>You guessed the correct player in {currAttempt} selections!</p>
            </div>
          ) : (
            <div>
              <p>Draft bust!</p>
              <p>You were not able to select the correct player.</p>
            </div>
          )}
          <p>
            The correct player is {correctPlayer.name}, {correctPlayer.position}{" "}
